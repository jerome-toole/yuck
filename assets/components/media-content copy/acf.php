...
acf_register_block_type([
    'name' => 'media-content', // Name/key, alphanumeric characters and dashes only.
    'title' =>  'Media & Content', // Label in block editor.
    'description' => 'Content with Image or Video', // A short description.
    'category' => 'granola-blocks', // Core: common | formatting | layout | widgets | embed.
    'icon' => 'id', // https://developer.wordpress.org/resource/dashicons/
    ...
    'render_callback' => function ($block, $content, $is_preview, $post_id) {
        ...
        echo \Granola\Component::get('media-content', $args);
    }
]);
